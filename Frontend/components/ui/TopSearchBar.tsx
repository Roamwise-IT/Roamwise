...
<View style={{ backgroundColor:  darkTheme.header.background, padding: padding.lg, borderTopLeftRadius: borderRadius.default,  borderTopRightRadius: borderRadius.default,  }}>
  {/* Search Bar */}
  <View
  style={{
    flexDirection: "row",
  ...
  >
    <Ionicons name="search" size={20} color={darkTheme.search.iconMuted} />
    <TextInput
  ...
  />
    <TouchableOpacity>
    <Ionicons name="options" size={24} color= {darkTheme.border.active} />
    </TouchableOpacity>
    </View>
    </View>
...
{/* Grey Strip for Direction Hint */}
    ...
    >
      <Text style={{ color: darkTheme.text.primary, fontSize: fontSizes.mdPlus, right: -50}}>
